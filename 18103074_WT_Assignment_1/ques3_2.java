...
public class ques3_2{
    ...
    public static void main(String[] args){
        ...
        System.out.print("Input the number of nodes and edges in the graph: ");
        int v = obj.nextInt(), e = obj.nextInt();
        System.out.print("Input edges start, end, weight: ");
        ...
        int start, dest;
        System.out.print("Input start node and destination node: ");
